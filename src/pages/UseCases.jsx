  ...
  return (
    <div className="min-h-screen bg-[#0A0A0B] text-slate-200 font-sans flex flex-col">
      ...
      <nav className="border-b border-white/10 bg-black/40 backdrop-blur-md sticky top-0 z-50 shrink-0">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <Link to="/use-cases" className="text-sm font-semibold text-white hover:text-indigo-400 transition-colors">Use Cases</Link>
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden bg-[#0A0A0B] border-b border-white/10 px-6 py-4 space-y-4 shadow-2xl animate-fade-in">
            ...
            <Link to="/use-cases" className="block text-sm font-semibold text-white hover:text-indigo-400 transition-colors" onClick={() => setIsMobileMenuOpen(false)}>Use Cases</Link>
      ...
      <main className="flex-1 max-w-5xl w-full mx-auto px-6 py-16 animate-fade-in">
        <h1 className="text-4xl md:text-5xl font-extrabold text-white tracking-tight mb-4 text-center">Who is Arukin For?</h1>
        <p className="text-slate-400 text-lg leading-relaxed mb-16 text-center max-w-2xl mx-auto">
        ...
        <div className="space-y-8">
          ...
          <div className="bg-gradient-to-r from-indigo-500/10 to-transparent border border-indigo-500/20 rounded-3xl p-8 md:p-10 flex flex-col md:flex-row gap-8 items-start relative overflow-hidden">
            <div className="absolute top-0 left-0 w-1 h-full bg-indigo-500"></div>
            <div className="h-14 w-14 rounded-2xl bg-indigo-500/20 flex items-center justify-center text-indigo-400 shrink-0 border border-indigo-500/30">
              <Zap size={28} />
            </div>
            <div>
              <h3 className="text-2xl font-bold text-white mb-3">The Power User: Unified Dashboard</h3>
              ...
              <ul className="space-y-2 text-sm text-slate-300">
                <li className="flex items-center gap-2"><ArrowRight size={14} className="text-indigo-400" /> Connect your personal, work, side-hustle, and spam accounts to a single dashboard.</li>
                <li className="flex items-center gap-2"><ArrowRight size={14} className="text-indigo-400" /> Search emails, preview Drive files, and manage contacts across all profiles without ever logging in and out.</li>
              </ul>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-emerald-500/10 to-transparent border border-emerald-500/20 rounded-3xl p-8 md:p-10 flex flex-col md:flex-row gap-8 items-start relative overflow-hidden">
            ...
            <div className="h-14 w-14 rounded-2xl bg-emerald-500/20 flex items-center justify-center text-emerald-400 shrink-0 border border-emerald-500/30">
              <Trash2 size={28} />
            </div>
            <div>
              <h3 className="text-2xl font-bold text-white mb-3">The Privacy Advocate: Inbox Zero & Cloud Cleanse</h3>
              <p className="text-slate-400 leading-relaxed mb-4">
                Want to deeply audit your own digital footprint? Use Arukin’s batch processing capabilities to reclaim your cloud hygiene.
              </p>
              <ul className="space-y-2 text-sm text-slate-300">
                <li className="flex items-center gap-2"><ArrowRight size={14} className="text-emerald-400" /> Use the <strong>Batch Threat Cleaner</strong> to instantly delete or trash entire thousands of spam emails at once.</li>
                <li className="flex items-center gap-2"><ArrowRight size={14} className="text-emerald-400" /> Clear out your entire email history in seconds.</li>
                <li className="flex items-center gap-2"><ArrowRight size={14} className="text-emerald-400" /> Detect and revoke rogue third-party applications secretly accessing your data.</li>
              </ul>
            </div>
          </div>

          {/* Use Case 3: Guardian */}
          <div className="bg-gradient-to-r from-purple-500/10 to-transparent border border-purple-500/20 rounded-3xl p-8 md:p-10 flex flex-col md:flex-row gap-8 items-start relative overflow-hidden">
            <div className="absolute top-0 left-0 w-1 h-full bg-purple-500"></div>
            <div className="h-14 w-14 rounded-2xl bg-purple-500/20 flex items-center justify-center text-purple-400 shrink-0 border border-purple-500/30">
              <Heart size={28} />
            </div>
            <div>
              <h3 className="text-2xl font-bold text-white mb-3">The Guardian: Family Protection</h3>
              <p className="text-slate-400 leading-relaxed mb-4">
          ...
          <div className="bg-gradient-to-r from-amber-500/10 to-transparent border border-amber-500/20 rounded-3xl p-8 md:p-10 flex flex-col md:flex-row gap-8 items-start relative overflow-hidden">
            ...
            <div className="h-14 w-14 rounded-2xl bg-amber-500/20 flex items-center justify-center text-amber-400 shrink-0 border border-amber-500/30">
              <Mailbox size={28} />
            </div>
            <div>
              <div className="flex items-center gap-2 mb-3">
                <h3 className="text-2xl font-bold text-white">The Operations Hub</h3>
                <span className="text-[10px] font-bold tracking-wider uppercase bg-amber-500/10 text-amber-400 border border-amber-500/20 px-2 py-0.5 rounded-full">Roadmap</span>
              </div>
              <p className="text-slate-400 leading-relaxed mb-4">
                Arukin is evolving into an automated communications and relay hub, adding massive value for small teams and power users.
              </p>
              <ul className="space-y-2 text-sm text-slate-300">
                <li className="flex items-center gap-2"><ArrowRight size={14} className="text-amber-400" /> <strong>Batch Email Sender:</strong> Dispatch scheduled newsletters, alerts, or RSVPs from any connected account.</li>
                <li className="flex items-center gap-2"><ArrowRight size={14} className="text-amber-400" /> <strong>OTP Interception & Relays:</strong> Forward time-sensitive 2FA verification codes to your dashboard instantly.</li>
                <li className="flex items-center gap-2"><ArrowRight size={14} className="text-amber-400" /> <strong>Email Forwarding:</strong> Automatically route important threads from connected members to a central address.</li>
              </ul>
            </div>
          </div>
