      ...
      <nav className="border-b border-white/5 bg-[#0a0a0c]/90 backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 md:px-6 h-16 flex items-center justify-between gap-2">
          <div className="flex items-center gap-3 shrink-0">
            ...
            <span className="hidden md:block font-display font-bold text-base tracking-tight text-white">Arukin</span>
          </div>
              ...
              <div className="space-y-4 mb-8 text-left">
                ...
                <div className="p-4 bg-white/5 border border-white/5 rounded-xl">
                  ...
                  <ul className="text-xs text-slate-400 leading-relaxed list-disc pl-4 space-y-2">
                    ...
                    <li>By proceeding, you grant Arukin read-only access to your connected account's metadata as outlined in our <a href="/privacy" target="_blank" className="text-gold hover:underline">Privacy Policy</a>.</li>
