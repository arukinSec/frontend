    ...
    <nav className="border-b border-emerald-deep/10 bg-cream/80 backdrop-blur-xl sticky top-0 z-50 shrink-0">
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-2">
          ...
          <a href="https://github.com/arukinSec" target="_blank" rel="noreferrer" className="flex items-center justify-center w-8 h-8 text-emerald-deep/60 hover:text-emerald-deep bg-emerald-deep/5 hover:bg-emerald-deep/10 rounded-full transition-colors ml-1" title="GitHub">
        ...
        <div className="md:hidden">
          <button onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)} className="text-emerald-deep" aria-label="Toggle menu">
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden bg-cream border-t border-emerald-deep/10 px-6 py-4 space-y-3">
          ...
          <div className="pt-3 border-t border-emerald-deep/10 space-y-2">
