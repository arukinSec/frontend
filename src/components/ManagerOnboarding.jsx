        ...
        <div className="flex-1 flex flex-col justify-start overflow-y-auto min-h-0">
          ...
          {step === 1 && (
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-center animate-slide-up">
              ...
              <div className="md:col-span-9 space-y-2">
                <h2 className="text-xl font-black text-white tracking-tight leading-tight">Welcome to Arukin</h2>
          ...
          {step === 2 && (
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-center animate-slide-up">
              ...
              <div className="md:col-span-9 space-y-2">
                <h2 className="text-xl font-black text-white tracking-tight leading-tight">What Arukin Does</h2>
                <p className="text-slate-400 text-xs leading-relaxed">
